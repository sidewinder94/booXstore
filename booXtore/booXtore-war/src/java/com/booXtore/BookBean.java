...
public class BookBean implements Serializable {
    ...
    public String addBookToCart() throws IOException {
        ...
        return "product.xhtml?faces-redirect=true&id=" + book.getId();
    }
     ...
     *
     * @param book
     * @return un booleen permettant de déterminer si le livre est en stock ou
     * non méthode non utilisée
     */
    ...
    /**
     *
     * @return renvoie la date de sortie d'un ouvrage en tant que String
     */
