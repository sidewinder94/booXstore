...
INSERT IGNORE INTO `books`(`TITLE`, `SUMMARY`, `CATEGORY_ID`, `PUBLISHER_ID`, `STATES_ID`, `SUPPLY`, `THRESHOLD`, `RELEASEDATE`, `PRICE`, `IMAGENAME`)VALUES ("Mon livre de coloriage my little Pony", "Des jeux simples et des stickers pour les petits.", 11, 0, 0, 5, 1, '2012-07-02', 2.80, "LittlePony_Color");

-- Ananas
INSERT IGNORE INTO `books`(`TITLE`, `SUMMARY`, `CATEGORY_ID`, `PUBLISHER_ID`, `STATES_ID`, `SUPPLY`, `THRESHOLD`, `RELEASEDATE`, `PRICE`, `IMAGENAME`)VALUES ("Comme un ananas", "Ouvrage publié à l'occasion de l'exposition «Comme un ananas», Carte Blanche à Philippe Katerine, présentée à la Galerie des Galeries, Galeries Lafayette Haussmann, du 4 avril au 2 juin 2012.", 12, 12, 0, 20, 5, '2012-04-05', 17.50, "CommeAnanas");
...
INSERT IGNORE INTO `books`(`TITLE`, `SUMMARY`, `CATEGORY_ID`, `PUBLISHER_ID`, `STATES_ID`, `SUPPLY`, `THRESHOLD`, `RELEASEDATE`, `PRICE`, `IMAGENAME`)VALUES ("The Mortal Instruments, Tome 4 : La cité des anges déchus", "La guerre est terminée. Clary rentre à New York pour s'entraîner à devenir Chasseur d'Ombres. Mais les tensions se ravivent avec les Créatures Obscures, des Chasseurs d'Ombres sont assassinés... Les deux camps se préparent à une nouvelle confrontation et se disputent Simon, un vampire aux nombreux pouvoirs. Ils ne reculeront devant rien. Au risque pour Clary de perdre tous ceux qu'elle aime y compris lace.", 6, 15, 0, 20, 5, '2013-06-07', 17.99, "TMI_tome3");
-- Berlin
...
-- -------------------------------------------------------------------------------------------------- --
-- Create Orders
-- INSERT INTO `orders`(`ORDERDATE`, `TOTALPRICE`, `USERS_ID`) VALUES ([value-2],[value-3],[value-4])
-- -------------------------------------------------------------------------------------------------- --
INSERT IGNORE INTO `orders`(`ORDERDATE`, `TOTALPRICE`, `USERS_ID`) VALUES ('2013-11-10', 28.99, 1);
INSERT IGNORE INTO `orders`(`ORDERDATE`, `TOTALPRICE`, `USERS_ID`) VALUES ('2013-11-10', 5.60, 2);
INSERT IGNORE INTO `orders`(`ORDERDATE`, `TOTALPRICE`, `USERS_ID`) VALUES ('2013-11-10', 111.92, 0);

-- -------------------------------------------------------------------------------------------------------- --
-- Create Book_Orders
-- INSERT INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES ([value-2],[value-3],[value-4])
-- -------------------------------------------------------------------------------------------------------- --
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 0, 0);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 35, 1);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 36, 1);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 24, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 25, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 26, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 27, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 28, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 29, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 30, 2);
INSERT IGNORE INTO `books_orders`(`QUANTITY`, `BOOKID_ID`, `ORDERID_ID`) VALUES (1, 31, 2);